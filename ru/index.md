...
Небольшие тексты можно набрать прямо в браузере через [веб-редактор](https://www.ponomar.net/cu_vkeyb.html). Или используйте наш [переводчик из гражданского шрифта в ЦСЯ](https://sci.ponomar.net/translate).
