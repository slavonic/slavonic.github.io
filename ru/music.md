...
* [Политика использования Зоны личного пользования](http://www.ponomar.net/files/pua_policy.pdf) 
  (содержит перечень временных кодовых точек)

* [Шрифты для набора знаменной нотации](https://github.com/slavonic/fonts-znam)
 (в кодировке Юникод)

* [Песочница для работы с знаменной нотацией](http://www.ponomar.net/wiki/doku.php?id=znamenny_manual)

На данном этапе, все шрифты и программы предоставляются без каких-бы то ни было
гарантийных обязательств и предназначены для использования ТОЛЬКО В ЦЕЛЯХ
