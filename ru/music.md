...
нотаций пока еще не доступен в Юникоде. Наша инициативная группа подала заявку
в концорциум Юникод для кодирования крюковой нотации. **Внимание**: предложение
по кодированию еще не принято, и кодовые точки могут измениться.
...
(нотации Типа А по классификации И. А. Гарднера).
 ...
 [Скачать документацию](https://www.ponomar.net/files/fonts-znam.pdf)
