...
Если Вам нужно набирать церковнославянский текст без установки клавиатурного драйвера, Вы можете воспользоваться [виртуальной клавиатурой](https://github.com/slavonic/cu-virtual-keyboard).
...
Среда верстки MikTeX автоматически устанавливает пакеты, используемые в документе. Однако по умолчанию словари переноса не загружаются. Для корректной работы переносов в церковнославянском языке требуется включить `churchslavonic` в настройках консоли MikTeX. 
